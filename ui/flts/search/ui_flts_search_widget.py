...
#
# Created: Mon Apr  6 00:11:24 2020
...
class Ui_FltsSearchWidget(object):
    def setupUi(self, FltsSearchWidget):
        ...
        self.gridLayout.addWidget(self.lbl_results_count, 4, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.tb_results, 3, 0, 1, 4)
        self.groupBox = QtGui.QGroupBox(FltsSearchWidget)
        ...
        self.cbo_column = QtGui.QComboBox(self.groupBox)
        self.cbo_column.setMinimumSize(QtCore.QSize(150, 20))
        self.cbo_column.setObjectName(_fromUtf8("cbo_column"))
        self.horizontalLayout.addWidget(self.cbo_column)
        self.label_3 = QtGui.QLabel(self.groupBox)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.horizontalLayout.addWidget(self.label_3)
        self.cbo_expression = QtGui.QComboBox(self.groupBox)
        ...
        self.horizontalLayout.addWidget(self.cbo_expression)
        self.txt_keyword = QgsFilterLineEdit(self.groupBox)
        ...
        self.btn_sort = QtGui.QPushButton(self.groupBox)
        self.btn_sort.setText(_fromUtf8(""))
        icon = QtGui.QIcon()
        ...
        self.btn_search.setMinimumSize(QtCore.QSize(150, 20))
        ...
        self.btn_advanced_search = QtGui.QPushButton(self.groupBox)
        self.btn_advanced_search.setMinimumSize(QtCore.QSize(150, 20))
        icon2 = QtGui.QIcon()
        ...
        self.horizontalLayout.addWidget(self.btn_advanced_search)
        spacerItem = QtGui.QSpacerItem(62, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.gridLayout.addWidget(self.groupBox, 1, 0, 1, 4)
        self.btn_clear = QtGui.QPushButton(FltsSearchWidget)
        self.btn_clear.setMinimumSize(QtCore.QSize(150, 20))
        self.btn_clear.setMaximumSize(QtCore.QSize(200, 16777215))
        icon3 = QtGui.QIcon()
    ...
    def retranslateUi(self, FltsSearchWidget):
        self.groupBox.setTitle(QtGui.QApplication.translate("FltsSearchWidget", "Define Filter", None, QtGui.QApplication.UnicodeUTF8))
