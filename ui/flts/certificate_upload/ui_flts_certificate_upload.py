...
class Ui_FltsCertUploadWidget(object):
    def setupUi(self, FltsCertUploadWidget):
        ...
        self.gridLayout_2.addWidget(self.lbl_records_count, 4, 2, 1, 1)
        ...
        self.pgbar_upload = QtGui.QProgressBar(FltsCertUploadWidget)
        self.pgbar_upload.setEnabled(True)
        self.pgbar_upload.setProperty("value", 0)
        self.pgbar_upload.setObjectName(_fromUtf8("pgbar_upload"))
        self.gridLayout_2.addWidget(self.pgbar_upload, 3, 0, 1, 3)
