...
SET POPULATE="%USERPROFILE%\.qgis2\python\plugins\stdm\scripts\flts\populate_tables.sql"
SET FUNC="%USERPROFILE%\.qgis2\python\plugins\stdm\scripts\flts\custom_functions.sql"
SET TRIGGER="%USERPROFILE%\.qgis2\python\plugins\stdm\scripts\flts\flts_triggers.sql"
